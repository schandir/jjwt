package com.nathan.jjwt.controller;

import com.nathan.jjwt.service.SecretService;
import io.jsonwebtoken.Claims;
import io.jsonwebtoken.Jws;
import io.jsonwebtoken.Jwts;
import io.jsonwebtoken.SignatureAlgorithm;
import com.nathan.jjwt.model.JwtResponse;
...
public class StaticJWTController extends BaseController {
    ...
    public JwtResponse fixedBuilder() throws UnsupportedEncodingException {
        String jws = Jwts.builder()
            .setIssuer("Nathan")
            .setSubject("My JWT Test")
            .claim("name", "Nathan Chandir")
            .claim("scope", "admins")
