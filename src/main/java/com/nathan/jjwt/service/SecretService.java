package com.nathan.jjwt.service;
...
public class SecretService {
    ...
    public Map<String, String> refreshSecrets() {
        String staticKey = "jake";
        secrets.put(SignatureAlgorithm.HS256.getValue(), TextCodec.BASE64.encode(staticKey));
        SecretKey key = MacProvider.generateKey(SignatureAlgorithm.HS384);
